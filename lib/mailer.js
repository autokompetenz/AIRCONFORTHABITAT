...
async function sendStatusNotification({ email, name, reservationNumber, status, puppy }) {
  ...
  const content = `
    <div style="text-align:center;margin-bottom:32px;">
      ...
      <h1 style="margin:0 0 8px;font-size:28px;font-weight:900;color:#ffffff;letter-spacing:-0.02em;">Mise à jour de votre réservation</h1>
      <p style="margin:0;font-size:15px;color:rgba(255,255,255,0.45);">Bonjour ${name},</p>
    </div>
    <div style="background:rgba(201,118,46,0.06);border:1px solid rgba(201,118,46,0.2);border-radius:10px;padding:24px;text-align:center;margin-bottom:28px;">
      <div style="font-size:11px;font-weight:800;letter-spacing:0.35em;text-transform:uppercase;color:rgba(255,255,255,0.3);margin-bottom:12px;">Nouveau statut</div>
      <div style="font-size:24px;font-weight:900;color:#C9762E;letter-spacing:0.02em;margin-bottom:6px;">${label}</div>
      <div style="font-size:13px;color:rgba(255,255,255,0.3);">Réservation n° ${reservationNumber}</div>
    </div>
    ${puppy ? `<p style="font-size:14px;color:rgba(255,255,255,0.5);text-align:center;margin:0 0 24px;">Concernant ${puppy.name} (${puppy.breed})</p>` : ''}
    <p style="font-size:13px;color:rgba(255,255,255,0.25);text-align:center;margin:0;">
