...
const SERVICES = [
  ...
  { icon:'📦', fr:'Livraison Belgique', nl:'Bezorging België', en:'Delivery Belgium',
    descFr:'Livraison rapide et sécurisée dans toute la Belgique et le Grand-Duché.', descNl:'Snelle en veilige levering in heel België en Luxemburg.', descEn:'Fast and secure delivery throughout Belgium and Luxembourg.' },
];
