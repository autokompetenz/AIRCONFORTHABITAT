...
Hébergeur : Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, USA`,
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          text: 'Vos données ne sont jamais cédées à des tiers. Elles sont accessibles uniquement à l\'équipe d\'AIR ECO CLIM.',
        },
        {
    ...
    },
    {
      ...
      sections: [
        ...
        {
          sub: '3. Prix',
          text: 'Les prix sont indiqués en euros (€), TVA comprise au taux en vigueur (20%). Le paiement est exigible à la commande.',
        },
        {
          sub: '4. Livraison',
...
Hosting : Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, VS`,
    },
    {
      ...
      sections: [
        ...
        { sub: '6. Ontvangers van gegevens', text: 'Uw gegevens worden nooit aan derden verstrekt. Ze zijn alleen toegankelijk voor het AIR ECO CLIM-team.' },
    ...
    },
    {
      ...
      sections: [
        ...
        { sub: '3. Prijs en betaling', text: 'Prijzen zijn in euro (€), inclusief BTW tegen het geldende tarief (20%). Betaling is verschuldigd bij bestelling.' },
...
Hosting : Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, USA`,
    },
    {
      ...
      sections: [
        ...
        { sub: '6. Data Recipients', text: 'Your data is never shared with third parties. It is only accessible to the AIR ECO CLIM team.' },
    ...
    },
    {
      ...
      sections: [
        ...
        { sub: '3. Price and Payment', text: 'Prices are in euros (€), VAT included at the applicable rate (20%). Payment is due upon ordering.' },
